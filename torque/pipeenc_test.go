...
func TestEncoder_PutInt(t *testing.T) {
	enc := NewEncoder()
	enc.PutInt(1)
	enc.PutInt(23)
	enc.PutInt(456)
...
func TestDecoder_GetInt(t *testing.T) {
...
func TestDecoder_GetInt_rejectsBadInput(t *testing.T) {
	badCases := []string{
		"|",
		"12a|",
		"1234", // no delimiter
...
func TestDecoder_GetString_rejectsBadInput(t *testing.T) {
	badCases := []string{
		"|",
		"12a|",
		"1234", // no delimiter
